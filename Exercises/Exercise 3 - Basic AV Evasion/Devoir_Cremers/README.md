...
## Observation/Analyse
A la lecture de l'énoncé et l'observation des programmes figurant en solutions d'exemple, j'ai décidé de tenter une approche progressive des techniques d'évasion jusqu'à compromission de la VM de test, pour autant que la compromission soit possible. 
